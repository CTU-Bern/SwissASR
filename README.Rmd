...
Participant safety is a big issue in clinical trials and reporting safety related events to the authorities is mandatory for certain trial types. One aspect of this is the annual safety report (ASR) which contains both summary information and listings of safety events. The `swiss_asr` R package helps in compiling this report.
...
The package can be installed from [github](https://github.com/CTU-Bern/SwissASR) 
